# todos of estes sublease agreements were created by Claude.
...
SUBLESSOR: Apex Innovations, Inc., a Delaware corporation with its principal place of business at 1234 Tech Boulevard, suíte 5000, San Francisco, CA 94105 (hereinafter referred to as the "Sublessor")
...
1.1 Descrição: Sublessor hereby subleases to Sublessee, and Sublessee hereby subleases from Sublessor, a portion of the Master Premises consisting of approximately 15,000 square feet of office space located on the 11th floor of the building at 9876 Innovation Park, Building C, San Francisco, CA 94107 (hereinafter referred to as the "Subleased Premises"). The Subleased Premises are more particularly described in Exhibit A attached hereto and incorporated herein by reference.
...
2.2 Option to Extend: Provided that Sublessee is not in padrão under any of the terms and conditions of this Sublease, Sublessee shall have one (1) option to extend the term of this Sublease para an additional period of three (3) years (the "Extension Term") upon the same terms and conditions contained in this Sublease, except that the Base Rent during the Extension Term shall be as definir forth in Section 3.2 below. Sublessee shall exercise this option by giving Sublessor written notice of its intent to do so no later than nine (9) months prior to the expiration of the Initial Term.

3. RENT

3.1 Base Rent para Initial Term: Commencing on the Commencement Date and continuing throughout the Initial Term, Sublessee shall pay to Sublessor as base rent para the Subleased Premises the sum of Seventy-Five Thousand Dollars ($75,000.00) per month ("Base Rent"). Base Rent shall be payable in advance on or before the first day of each calendar month during the Term, without notice, demand, deduction, or offset.

3.2 Base Rent para Extension Term: se Sublessee exercises its option to extend the Term as provided in Section 2.2, the Base Rent para the Extension Term shall be the greater of (i) the Base Rent in effect immediately prior to the commencement of the Extension Term, increased by three percent (3%) per annum, compounded annually, or (ii) the then-prevailing fair market rental rate para comparable space in the building and surrounding area, as mutually agreed upon by Sublessor and Sublessee. se Sublessor and Sublessee are unable to agree upon the fair market rental rate within thirty (30) days after Sublessee's exercise of the extension option, the fair market rental rate shall be determined by arbitration in accordance with the procedures definir forth in Exhibit B attached hereto.

3.3 Additional Rent: In addition to the Base Rent, Sublessee shall pay to Sublessor as additional rent Sublessee's Proportionate Share (as defined below) of Operating Expenses (as defined in the Master Lease) para the Master Premises. Sublessee's Proportionate Share shall be thirty percent (30%), which is the percentage obtained by dividing the rentable square footage of the Subleased Premises (15,000 sq. ft.) by the rentable square footage of the Master Premises (50,000 sq. ft.). Sublessee's obligation to pay additional rent shall commence on the Commencement Date and shall be payable in monthly installments as provided in the Master Lease.

3.4 Late Charges: se any installment of Base Rent or additional rent is not received by Sublessor within five (5) days after the date when due, Sublessee shall pay to Sublessor a late charge equal to five percent (5%) of the overdue amount to cover the extra expense involved in handling delinquent payments. The parties agree that this late charge represents a fair and reasonable estimate of the costs that Sublessor will incur by reason of late payment by Sublessee.
...
4.2 Use and retornar: Sublessor may, but shall not be obligated to, use the Security Deposit or any portion thereof to cure any breach or padrão by Sublessee under this Sublease, or to compensate Sublessor para any damage isso incurs as a result of Sublessee's failure to perform any of its obligations hereunder. se Sublessor uses any portion of the Security Deposit, Sublessee shall, within ten (10) days after written demand therefor, restore the Security Deposit to its original amount. Provided that Sublessee has fully and faithfully performed all of its obligations under this Sublease, Sublessor shall retornar the Security Deposit, or any balance thereof, to Sublessee within thirty (30) days after the expiration or earlier termination of this Sublease.

5. USE

5.1 Permitted Use: The Subleased Premises shall be used and occupied by Sublessee solely para general office purposes and other uses permitted under the Master Lease, and para no other purpose without the prior written consent of Sublessor and Master Lessor.
...
5.3 Prohibited Uses: Sublessee shall not use or permit the use of the Subleased Premises in any manner that will (i) create waste or a nuisance, (ii) disturb other tenants or occupants of the building, (iii) invalidate or increase the premiums para any insurance policies covering the building or its contents, or (iv) violate any provision of the Master Lease.
...
6.2 Sublessor's Obligations: Sublessor shall have no obligation to maintain, repair, or substituir any portion of the Subleased Premises, except to the extent such obligation is imposed on Sublessor as the Tenant under the Master Lease. In such event, Sublessee shall promptly reimburse Sublessor para Sublessee's Proportionate Share of the costs incurred by Sublessor in performing such obligations.
...
8.3 Excess Rent: se Sublessor and Master Lessor consent to an assignment or subletting, any rent or other consideration payable to Sublessee in excess of the rent payable by Sublessee hereunder shall be paid to Sublessor as additional rent.
...
(c) Workers' Compensation Insurance as required by applicable law, and Employer's Liability Insurance with limits of not less than $1,000,000 per accident, $1,000,000 per employee para disease, and $1,000,000 policy limit para disease.

(d) Business Interruption Insurance in an amount sufficient to cover Sublessee's ongoing expenses, including without limitation, rent payments under this Sublease, para a period of not less than twelve (12) months.

9.2 Policy Requisitos: All insurance policies required to be maintained by Sublessee shall (i) be issued by insurance companies authorized to do business in the State of California with a financial rating of at least A-:VIII as rated in the most recent edition of Best's Insurance Reports, (ii) nome Sublessor and Master Lessor as additional insureds (except para Workers' Compensation and Property Insurance), (iii) be primary and non-contributory with any insurance carried by Sublessor or Master Lessor, (iv) provide that the insurer shall endeavor to give Sublessor at least thirty (30) days' prior written notice of any cancellation or material change in coverage, and (v) waive any right of subrogation against Sublessor and Master Lessor.
...
10.1 Sublessee's Indemnity: Sublessee shall indemnify, defend, and hold harmless Sublessor and Master Lessor, and their respective officers, directors, employees, agents, and representatives, from and against any and all claims, demands, liabilities, damages, judgments, costs, and expenses (including reasonable attorneys' fees) arising out of or relating to (i) Sublessee's use or occupancy of the Subleased Premises, (ii) any act or omission of Sublessee or its employees, agents, contractors, or invitees, or (iii) any breach or padrão by Sublessee under this Sublease.

10.2 Sublessor's Indemnity: Sublessor shall indemnify, defend, and hold harmless Sublessee, and its officers, directors, employees, agents, and representatives, from and against any and all claims, demands, liabilities, damages, judgments, costs, and expenses (including reasonable attorneys' fees) arising out of or relating to any breach or padrão by Sublessor under this Sublease.

11. DAMAGE AND DESTRUCTION

11.1 Termination Rights: se the Subleased Premises or the building in which they are located are damaged or destroyed by fire or other casualty to such an extent that, in Sublessor's reasonable judgment, the damage cannot be repaired within one hundred eighty (180) days after the date of such damage or destruction, either party may terminate this Sublease by giving written notice to the other party within thirty (30) days after the date of such damage or destruction.

11.2 Repair Obligations: se this Sublease is not terminated pursuant to Section 11.1, Sublessor shall repair and restore the Subleased Premises to substantially the same condition as existed immediately prior to such damage or destruction, subject to the terms and conditions of the Master Lease. Sublessee shall promptly repair or substituir its personal property, trade fixtures, and equipment.

11.3 Rent Abatement: se the Subleased Premises are rendered wholly or partially untenantable by fire or other casualty, the rent shall be abated in proportion to the area of the Subleased Premises that is untenantable during the period of such untenantability.

12. CONDEMNATION

12.1 Termination Rights: se all or substantially all of the Subleased Premises are taken by eminent domain or conveyed under threat thereof, this Sublease shall terminate as of the date of such taking or conveyance. se a portion of the Subleased Premises is taken or conveyed, and the remaining portion is not sufficient para Sublessee's reasonable use and occupancy, either party may terminate this Sublease by giving written notice to the other party within thirty (30) days after the date of such taking or conveyance.

12.2 Award: Sublessee hereby waives any right to receive any portion of the award paid para such taking or conveyance, provided that Sublessee may make a separate claim para compensation para its personal property, trade fixtures, and moving expenses, so long as such claim does not diminish the award payable to Sublessor or Master Lessor.

13. padrão

13.1 Eventos of padrão: The occurrence of any of the following shall constitute a material padrão and breach of this Sublease by Sublessee:

(a) Failure to pay any rent or other sum payable hereunder within five (5) days after the date when due;

(b) Failure to observe or perform any other term, covenant, or condition of this Sublease, se such failure continues para a period of thirty (30) days after written notice thereof from Sublessor to Sublessee;

(c) The making by Sublessee of any general assignment para the benefit of creditors; the filing by or against Sublessee of a petition to have Sublessee adjudged a bankrupt or a petition para reorganization or arrangement under any law relating to bankruptcy; the appointment of a trustee or receiver to take possession of substantially all of Sublessee's assets or of Sublessee's interest in this Sublease; or the attachment, execution, or other judicial seizure of substantially all of Sublessee's assets or of Sublessee's interest in this Sublease;

(d) Sublessee's abandonment of the Subleased Premises;

(e) Any padrão by Sublessee under the Master Lease.

13.2 Remedies: In the event of any such padrão by Sublessee, Sublessor may, at any time thereafter, with or without notice or demand and without limiting Sublessor in the exercise of any right or remedy which Sublessor may have by reason of such padrão:
...
(b) Enter upon and take possession of the Subleased Premises and expel or remove Sublessee and any other person who may be occupying said premises or any part thereof, without being liable para prosecution or any claim para damages therefor;

(c) Recover from Sublessee all damages incurred by Sublessor by reason of Sublessee's padrão, including but not limited to (i) the cost of recovering possession of the Subleased Premises, (ii) expenses of reletting, including necessary renovation and alteration of the Subleased Premises, (iii) reasonable attorneys' fees, and (iv) the amount of rent and other charges which would have been payable by Sublessee para the remainder of the Term;
...
17.5 Severability: se any provision of this Sublease is held to be invalid, illegal, or unenforceable in any respect, such invalidity, illegality, or unenforceability shall not affect any other provision of this Sublease, and this Sublease shall be construed as se such invalid, illegal, or unenforceable provision had never been contained herein.
...
17.7 Counterparts: This Sublease may be executed in any número of counterparts, each of which shall be deemed an original, but all of which together shall constitute one and the same instrument.
...
EXHIBIT A: Descrição of Subleased Premises
[Detailed floor plan and Descrição of the 15,000 square feet on the 11th floor]

EXHIBIT B: Arbitration Procedures para Determining Fair Market Rental Rate
[Detailed procedures para selecting arbitrators and conducting the arbitration process]

"""


sample1 = """
Descrição: This is a commercial sublease agreement between Apex Innovations, Inc. (Sublessor) and Quantum Dynamics, LLC (Sublessee) para a portion of premises originally leased from Innovate Propriedades, LLP (Master Lessor).

<parties involved>
Sublessor: Apex Innovations, Inc.
Sublessee: Quantum Dynamics, LLC
Original lessor: Innovate Propriedades, LLP
</parties involved>

<property details>
Address: 9876 Innovation Park, Building C, 11th Floor, San Francisco, CA 94107
Descrição: 15,000 square feet of office space on the 11th floor
...
Additional rent: 30`%` of Operating Expenses para the Master Premises
</term and rent>

<responsibilities>
Utilities: Not explicitly specified, likely included in Operating Expenses
Maintenance: Sublessee responsible para interior maintenance and repairs
Repairs: Sublessee responsible para interior repairs; Sublessor responsible para repairs required under Master Lease
...
<consent and notices>
Landlord's consent: Required para sublease to be effective
Notice Requisitos: Written notices to be delivered personally, by registered or certified mail, or by overnight courier to specified addresses
</consent and notices>

<special provisions>
Alterations: Require prior written consent of Sublessor and Master Lessor
Assignment and subletting: Prohibited without prior written consent, with exceptions para certain Relacionado entities
Damage and destruction: Termination rights se repairs cannot be completed within 180 days
padrão: Detailed Eventos of padrão and remedies specified
Holdover: 150`%` of Base Rent para any holdover period
...
SUBLESSOR: TechHub Enterprises, LLC, a California limited liability company with its principal place of business at 5678 Market Street, suíte 3000, San Francisco, CA 94103 (hereinafter referred to as the "Sublessor")
...
1.1 Descrição: Sublessor hereby subleases to Sublessee, and Sublessee hereby subleases from Sublessor, a portion of the Master Premises consisting of approximately 25,000 square feet of office and laboratory space located on the 16th and 17th floors of the building at 1357 Innovation Avenue, San Francisco, CA 94158 (hereinafter referred to as the "Subleased Premises"). The Subleased Premises are more particularly described in Exhibit A attached hereto and incorporated herein by reference.
...
2.2 Early Access: Sublessee shall have the right to access the Subleased Premises fifteen (15) days prior to the Commencement Date para the purpose of installing Sublessee's furniture, fixtures, and equipment, provided that such early access does not interfere with Sublessor's operations or any work being performed by Sublessor in the Subleased Premises. Such early access shall be subject to all terms and conditions of this Sublease, except para the obligation to pay rent.

2.3 Option to Extend: Provided that Sublessee is not in padrão under any of the terms and conditions of this Sublease, Sublessee shall have two (2) Opções to extend the term of this Sublease para additional periods of three (3) years each (each, an "Extension Term") upon the same terms and conditions contained in this Sublease, except that the Base Rent during each Extension Term shall be as definir forth in Section 3.2 below. Sublessee shall exercise each option by giving Sublessor written notice of its intent to do so no later than twelve (12) months prior to the expiration of the then-current Term.

3. RENT

3.1 Base Rent para Initial Term: Commencing on the Commencement Date and continuing throughout the Initial Term, Sublessee shall pay to Sublessor as base rent para the Subleased Premises the following amounts ("Base Rent"):
...
3.2 Base Rent para Extension Terms: se Sublessee exercises its option(s) to extend the Term as provided in Section 2.3, the Base Rent para each Extension Term shall be the greater of (i) the Base Rent in effect immediately prior to the commencement of the applicable Extension Term, increased by four percent (4%) per annum, compounded annually, or (ii) the then-prevailing fair market rental rate para comparable office and laboratory space in the building and surrounding area, as mutually agreed upon by Sublessor and Sublessee. se Sublessor and Sublessee are unable to agree upon the fair market rental rate within sixty (60) days after Sublessee's exercise of the extension option, the fair market rental rate shall be determined by arbitration in accordance with the procedures definir forth in Exhibit B attached hereto.
...
4.3 Transfer of Security Deposit: se Sublessor transfers its interest in the Master Premises or this Sublease, Sublessor shall transfer the Security Deposit to its successor in interest, whereupon Sublessor shall be released from all liability para the retornar of the Security Deposit.

5. USE

5.1 Permitted Use: The Subleased Premises shall be used and occupied by Sublessee solely para general office purposes, research and development, and laboratory uses consistent with a BSL-2 (Biosafety Level 2) facility, and other uses permitted under the Master Lease, and para no other purpose without the prior written consent of Sublessor and Master Lessor.
...
6.2 Sublessor's Obligations: Sublessor shall have no obligation to maintain, repair, or substituir any portion of the Subleased Premises, except to the extent such obligation is imposed on Sublessor as the Tenant under the Master Lease and relates to the building structure, exterior walls, roof, and common building systems. In such event, Sublessee shall promptly reimburse Sublessor para Sublessee's Proportionate Share of the costs incurred by Sublessor in performing such obligations.

6.3 HVAC Systems: Notwithstanding anything to the contrary herein, Sublessee shall be responsible para the maintenance, repair, and replacement of any supplemental or dedicated HVAC systems serving the Subleased Premises, including those serving the laboratory areas.

7. ALTERATIONS AND IMPROVEMENTS

7.1 Sublessee's Alterations: Sublessee shall not make any alterations, additions, or improvements to the Subleased Premises (collectively, "Alterations") without the prior written consent of Sublessor and Master Lessor, which consent shall not be unreasonably withheld, conditioned, or delayed para non-structural Alterations that do not affect the building systems or structural elements. Any approved Alterations shall be made at Sublessee's sole cost and expense, in accordance with all applicable laws and building codes, and in a good and workmanlike manner.

7.2 Plans and Specifications: Prior to commencing any Alterations, Sublessee shall submit detailed plans and specifications to Sublessor and Master Lessor para approval. Sublessee shall reimburse Sublessor and Master Lessor para their reasonable out-of-pocket costs incurred in reviewing such plans and specifications.
...
10.1 Sublessee's Indemnity: Sublessee shall indemnify, defend, and hold harmless Sublessor and Master Lessor, and their respective officers, directors, employees, agents, and representatives, from and against any and all claims, demands, liabilities, damages, judgments, costs, and expenses (including reasonable attorneys' fees) arising out of or relating to (i) Sublessee's use or occupancy of the Subleased Premises, (ii) any act or omission of Sublessee or its employees, agents, contractors, or invitees, (iii) any breach or padrão by Sublessee under this Sublease, or (iv) the presence, use, handling, storage, or disposal of Hazardous Materials in the Subleased Premises by Sublessee or its employees, agents, contractors, or invitees.
...
(b) Failure to observe or perform any other term, covenant, or condition of this Sublease, se such failure continues para a period of thirty (30) days after written notice thereof from Sublessor to Sublessee; provided, however, that se the nature of such padrão is such that isso cannot reasonably be cured within such thirty (30) day period, Sublessee shall not be deemed to be in padrão se Sublessee commences such cure within such thirty (30) day period and thereafter diligently prosecutes such cure to completion;
...
17.7 Counterparts: This Sublease may be executed in any número of counterparts, each of which shall be deemed an original, but all of which together shall constitute one and the same instrument. Electronic signatures shall be deemed to be original signatures para all purposes.
...
17.12 Confidentiality: Sublessee acknowledges that the terms and conditions of this Sublease are to remain confidential para Sublessor's benefit, and may not be disclosed by Sublessee to anyone, by any manner or means, directly or indirectly, without Sublessor's prior written consent, except to Sublessee's attorneys, accountants, and other professional advisors, or as required by law.

17.13 Force Majeure: Neither party shall be responsible para delays in the performance of its obligations hereunder caused by acts of God, war, terrorist attack, pandemic, government regulation, riot, or other causes beyond the reasonable control of such party.
...
17.15 Brokers: Each party represents and warrants to the other that isso has not dealt with any broker or finder in connection with this Sublease, except para [Broker nome] representing Sublessor and [Broker nome] representing Sublessee. Each party shall indemnify, defend, and hold harmless the other party from and against any claims, liabilities, damages, costs, and expenses (including reasonable attorneys' fees) arising out of any breach of the foregoing representation and warranty.
...
17.17 Signage: Subject to Master Lessor's approval and the terms of the Master Lease, Sublessee shall have the right to install, at Sublessee's sole cost and expense, Sublessee's nome and logo on the entry door to the Subleased Premises and in the lobby directory para the building.
...
17.20 Waiver of Jury Trial: TO THE FULLEST EXTENT PERMITTED BY LAW, SUBLESSOR AND SUBLESSEE HEREBY WAIVE THEIR RESPECTIVE RIGHT TO TRIAL BY JURY IN ANY ACTION OR PROCEEDING BASED UPON, OR Relacionado TO, THE SUBJECT MATTER OF THIS SUBLEASE.
...
EXHIBIT A: Descrição of Subleased Premises
[Detailed floor plan and Descrição of the 25,000 square feet on the 16th and 17th floors]

EXHIBIT B: Arbitration Procedures para Determining Fair Market Rental Rate
[Detailed procedures para selecting arbitrators and conducting the arbitration process]

EXHIBIT C: Form of Commencement Date Memorandum
[Template para documenting the actual Commencement Date and Expiration Date]

EXHIBIT D: Rules and Regulations
[List of building rules and regulations applicable to all tenants]

EXHIBIT E: Laboratory Safety Guidelines
[Specific guidelines para the safe operation of the BSL-2 laboratory facilities]
"""

sample2 = """
Descrição: This is a commercial sublease agreement between TechHub Enterprises, LLC (Sublessor) and NanoSphere Solutions, Inc. (Sublessee) para a portion of premises originally leased from Skyline Propriedades, Inc. (Master Lessor). The sublease is para office and laboratory space, including provisions para BSL-2 laboratory use, with a 5-year initial term and two 3-year extension Opções.

<parties involved>
Sublessor: TechHub Enterprises, LLC
Sublessee: NanoSphere Solutions, Inc.
Original lessor: Skyline Propriedades, Inc.
</parties involved>

<property details>
Address: 1357 Innovation Avenue, 16th and 17th Floors, San Francisco, CA 94158
Descrição: 25,000 square feet of office and laboratory space
...
Option to extend: Two 3-year extension Opções
Additional rent: 33.33`%` of Operating Expenses para the Master Premises
</term and rent>

<responsibilities>
Utilities: Sublessee responsible para all utilities and services
Maintenance: Sublessee responsible para interior maintenance and repairs, including laboratory-specific equipment and systems
Repairs: Sublessee responsible para interior repairs; Sublessor responsible para building structure, exterior walls, roof, and common building systems
...
Alterations: Require prior written consent of Sublessor and Master Lessor
Assignment and subletting: Prohibited without prior written consent, with exceptions para certain Relacionado entities
Hazardous materials: Sublessee permitted to use Hazardous Materials necessary para office operations and laboratory use, subject to compliance with laws and regulations
Damage and destruction: Termination rights se repairs cannot be completed within 270 days
Early access: 15 days prior to Commencement Date para furniture and equipment Instalação
Parking: Non-exclusive use of Sublessee's Proportionate Share of parking spaces
Signage: Right to install nome and logo on entry door and lobby directory, subject to approval
Access: 24/7 access to Subleased Premises
Environmental compliance: Sublessee responsible para compliance with environmental laws and remediation of any contamination caused by Sublessee
</special provisions>
"""
...
1.1 Descrição: Sublessor hereby subleases to Sublessee, and Sublessee hereby subleases from Sublessor, a portion of the Master Premises consisting of approximately 35,000 square feet of office, laboratory, and research space located on the 29th and 30th floors of the building at 555 Innovation Tower, San Francisco, CA 94105 (hereinafter referred to as the "Subleased Premises"). The Subleased Premises are more particularly described in Exhibit A attached hereto and incorporated herein by reference.
...
2.2 Early Access: Sublessee shall have the right to access the Subleased Premises thirty (30) days prior to the Commencement Date para the purpose of installing Sublessee's furniture, fixtures, equipment, and laboratory systems, provided that such early access does not interfere with Sublessor's operations or any work being performed by Sublessor in the Subleased Premises. Such early access shall be subject to all terms and conditions of this Sublease, except para the obligation to pay rent.

2.3 Option to Extend: Provided that Sublessee is not in padrão under any of the terms and conditions of this Sublease, Sublessee shall have one (1) option to extend the term of this Sublease para an additional period of five (5) years (the "Extension Term") upon the same terms and conditions contained in this Sublease, except that the Base Rent during the Extension Term shall be as definir forth in Section 3.2 below. Sublessee shall exercise this option by giving Sublessor written notice of its intent to do so no later than twelve (12) months prior to the expiration of the Initial Term.
...
3.2 Base Rent para Extension Term: se Sublessee exercises its option to extend the Term as provided in Section 2.3, the Base Rent para the Extension Term shall be the greater of (i) the Base Rent in effect immediately prior to the commencement of the Extension Term, increased by three and a half percent (3.5%) per annum, compounded annually, or (ii) the then-prevailing fair market rental rate para comparable office, laboratory, and research space in the building and surrounding area, as mutually agreed upon by Sublessor and Sublessee. se Sublessor and Sublessee are unable to agree upon the fair market rental rate within sixty (60) days after Sublessee's exercise of the extension option, the fair market rental rate shall be determined by arbitration in accordance with the procedures definir forth in Exhibit B attached hereto.
...
(d) Business Interruption Insurance in an amount sufficient to cover Sublessee's ongoing expenses, including without limitation, rent payments under this Sublease, para a period of not less than eighteen (18) months.
...
12.1 Eventos of padrão: The occurrence of any of the following shall constitute a material padrão and breach of this Sublease by Sublessee:

(a) Failure to pay any rent or other sum payable hereunder within five (5) days after the date when due;

(b) Failure to observe or perform any other term, covenant, or condition of this Sublease, se such failure continues para a period of thirty (30) days after written notice thereof from Sublessor to Sublessee;

(c) The making by Sublessee of any general assignment para the benefit of creditors; the filing by or against Sublessee of a petition to have Sublessee adjudged a bankrupt or a petition para reorganization or arrangement under any law relating to bankruptcy;
...
16.5 Severability: se any provision of this Sublease is held to be invalid, illegal, or unenforceable in any respect, such invalidity, illegality, or unenforceability shall not affect any other provision of this Sublease, and this Sublease shall be construed as se such invalid, illegal, or unenforceable provision had never been contained herein.
...
16.7 Counterparts: This Sublease may be executed in any número of counterparts, each of which shall be deemed an original, but all of which together shall constitute one and the same instrument. Electronic signatures shall be deemed to be original signatures para all purposes.
...
16.13 Force Majeure: Neither party shall be responsible para delays in the performance of its obligations hereunder caused by acts of God, war, terrorist attack, pandemic, government regulation, riot, or other causes beyond the reasonable control of such party.

16.14 Quiet Enjoyment: Sublessor covenants that Sublessee, upon paying the rent and performing all of the terms, covenants, and conditions of this Sublease, shall peaceably and quietly have, hold, and enjoy the Subleased Premises during the Term, subject to the terms and conditions of this Sublease and the Master Lease.

16.15 Brokers: Each party represents and warrants to the other that isso has not dealt with any broker or finder in connection with this Sublease, except para [Broker nome] representing Sublessor and [Broker nome] representing Sublessee. Each party shall indemnify, defend, and hold harmless the other party from and against any claims, liabilities, damages, costs, and expenses (including reasonable attorneys' fees) arising out of any breach of the foregoing representation and warranty.

16.16 Parking: Sublessee shall have the right to use, on a non-exclusive basis, Sublessee's Proportionate Share of the parking spaces allocated to Sublessor under the Master Lease, subject to the terms and conditions of the Master Lease and any rules and regulations promulgated by Master Lessor or Sublessor.

16.17 Signage: Subject to Master Lessor's approval and the terms of the Master Lease, Sublessee shall have the right to install, at Sublessee's sole cost and expense, Sublessee's nome and logo on the entry door to the Subleased Premises, in the lobby directory para the building, and on one panel of the building's monument sign.
...
16.20 Waiver of Jury Trial: TO THE FULLEST EXTENT PERMITTED BY LAW, SUBLESSOR AND SUBLESSEE HEREBY WAIVE THEIR RESPECTIVE RIGHT TO TRIAL BY JURY IN ANY ACTION OR PROCEEDING BASED UPON, OR Relacionado TO, THE SUBJECT MATTER OF THIS SUBLEASE.
...
EXHIBIT A: Descrição of Subleased Premises
[Detailed floor plan and Descrição of the 35,000 square feet on the 29th and 30th floors]
...
[Detailed plan para the handling, storage, and disposal of Hazardous Materials used in the Subleased Premises]
"""

sample3 = """
Descrição: This is a commercial sublease agreement between InnovateTech Holdings, Inc. (Sublessor) and BioGen Dynamics, Corp. (Sublessee) para a portion of premises originally leased from SkyScrapers Development Co. (Master Lessor). The sublease is para office, laboratory, and research space, including provisions para BSL-2 laboratory use, with a 6-year initial term and one 5-year extension option.
...
Descrição: 35,000 square feet of office, laboratory, and research space
...
Additional rent: 35`%` of Operating Expenses para the Master Premises
</term and rent>
...
Assignment and subletting: Prohibited without prior written consent, with exceptions para certain Relacionado entities
Hazardous materials: Sublessee permitted to use Hazardous Materials necessary para office operations and laboratory use, subject to compliance with laws and regulations
Damage and destruction: Termination rights se repairs cannot be completed within 365 days
Early access: 30 days prior to Commencement Date para furniture, equipment, and laboratory systems Instalação
Parking: Non-exclusive use of Sublessee's Proportionate Share of parking spaces
Signage: Right to install nome and logo on entry door, lobby directory, and building monument sign
